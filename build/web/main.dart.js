  ...
  dart.defineLazy(CT, {
    ...
    get C58() {
      return C[58] = dart.const({
        ...
        [FirebaseOptions_storageBucket]: "todoappsample-4b4fa.firebasestorage.app",
        [FirebaseOptions_databaseURL]: null,
        [FirebaseOptions_authDomain]: "todoappsample-4b4fa.firebaseapp.com",
        [FirebaseOptions_projectId]: "todoappsample-4b4fa",
        [FirebaseOptions_messagingSenderId]: "829773437074",
        [FirebaseOptions_appId]: "1:829773437074:web:737b5447ff6bab78dc6e4b",
        [FirebaseOptions_apiKey]: "AIzaSyCl7akSFJGo8xHPLvgS9xVE2QxlAHtQwWo"
      });
    },
    get C59() {
  ...
  main._TodoListScreenState = class _TodoListScreenState extends framework.State$(main.TodoListScreen) {
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: C[12] || CT.C12, elevation: 2}), body: new basic.Column.new({children: T$.JSArrayOfWidget().of([new basic.Padding.new({padding: C[13] || CT.C13, child: new basic.Row.new({children: T$.JSArrayOfWidget().of([new basic.Expanded.new({child: new text_field.TextField.new({controller: this[_controller], decoration: C[14] || CT.C14, onSubmitted: dart.fn(_ => this[_addTodo](), T$.StringTovoid())})}), C[16] || CT.C16, new elevated_button._ElevatedButtonWithIcon.new({onPressed: dart.bind(this, _addTodo), icon: C[17] || CT.C17, label: C[19] || CT.C19, style: elevated_button.ElevatedButton.styleFrom({padding: C[20] || CT.C20})})])})}), C[21] || CT.C21, new basic.Expanded.new({child: new (T$.StreamBuilderOfQuerySnapshotOfObjectN()).new({stream: this[_todosRef].orderBy("createdAt", {descending: true}).snapshots(), builder: dart.fn((context, snapshot) => {
                  ...
                  return new scroll_view.ListView.separated({padding: C[26] || CT.C26, itemCount: docs[$length], separatorBuilder: dart.fn((_, __) => C[21] || CT.C21, T$.BuildContextAndintToDivider()), itemBuilder: dart.fn((context, index) => {
                      let t0, t0$;
